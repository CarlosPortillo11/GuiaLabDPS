  ...
  return(
    <View style={styles.viewForm}>
      <View style={styles.viewInputs}>
        ...
        />
        <TextInput placeholder="Interés %" keyboardType="numeric"
          style={[styles.input, styles.inputPercentage]}
          onChange={(e) => setInterest(e.nativeEvent.text)}
        />
      </View>
      <RNPickerSelect style={picketSelectStyles.inputAndroid} onValueChange={(value) => setMonths(value)} placeholder={{
